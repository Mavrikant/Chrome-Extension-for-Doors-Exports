  ...
  if (element) {
    if (element.childNodes.length === 1) {
      if (!element.innerText.includes("http")) {
        element.innerHTML = '<a href="' + result.serverPath + element.innerHTML.trim() + '.html"><img id="Doors" height="20px" src="' + chrome.runtime.getURL("doors.png") + '">' + element.innerHTML + '</a>'
      }
    }
  }
});